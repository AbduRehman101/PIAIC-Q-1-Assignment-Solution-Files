...
{
    let AbduRehman = "Hello AbduRehman, would you like to learn some typescript today?";
    console.log(AbduRehman);
}
//2 -- Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
{
    const namcase = "AbduRehman";
...
var quote = "Albert Einstein:Life is like riding a bicycle. To keep your balance, you must keep moving.";
console.log(quote);
...
{
    var message = "Albert Einstein:Life is like riding a bicycle. To keep your balance, you must keep moving.";
    var AlbertEinstein = message;
...
{
    var fname = ["AbduRehman", "Moon", "Anas", "Bilal"];
...
{
    const peeps = ["AbduRehman", "Moon", "Anas", "Bilal"];
...
{
    const favcars = ["Honda", "Ferrir", "Rolls Royace"];
...
{
    const mem = ["Fahad", "Moon", "Xyz"];
    for (let index = 0; index < mem.length; index++) {
        const element = mem[index];
        console.log("Dear", mem[index], "I Humbly invite you to my dinner at my home at sunday 8:30 looking for your way here bye.");
    }
}
//13 -- Changing Guest List: You just heard that one of your guests can’t make the dinner,
// so you need to send out a new set of invitations. You’ll have to think of someone else to invite.
{
    const ori = ["Fahad", "Moon", "Xyz"];
    const newg = "Uncle";
    const invitedGuests = ori.filter((guest) => guest !== "Fahad");
...
{
    const placesToVisit = ["Paris", "London", "Taj Mahal", "Dubai", "Gawdar"];
...
{
    let langs = ["urdu", "River", "K-2", "Germany"];
...
{
    let me = "AbduRehman";
    console.log("IS That == 'AbduRehman'? i predict true");
    console.log(me == 'AbduRehman');
    console.log("Was He == 'AbduRehman' Attending The class?", "i predict no");
    console.log(me != 'AbduRehman');
    console.log("Did he == 'AbduRehman' ate his lunch? i predict yeah");
    console.log(me == "AbduRehman");
    console.log("is he =='AbduRehman' wearing white clothes? i predict no");
    console.log(me == 'AbduRehman');
    console.log("is he == 'AbduRehman' inside there? i predict yes");
    console.log(me == 'AbduRehman');
    console.log("is that his == 'AbduRehman' brush? i predict yes");
    console.log(me == 'AbduRehman');
    console.log("does AbduRehman likes to eat that? i predict no ");
    console.log(me != 'AbduRehman');
...
// Hello Admin
const usnames = ["AbduRehman", "Moon", "Anas", "Bilal"];
for (const username of usnames) {
    if (username === "AbduRehman") {
...
function describeCity(cityName, country = "India") {
...
// const album = {};
// albumlbum["artist_name"] = artistName;
