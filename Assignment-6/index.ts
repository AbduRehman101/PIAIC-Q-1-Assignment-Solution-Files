...
{
    let AbduRehman: string = "Hello AbduRehman, would you like to learn some typescript today?";
...
var quote: string = "Albert Einstein:Life is like riding a bicycle. To keep your balance, you must keep moving."
console.log(quote);
...
{
    var message: string = "Albert Einstein:Life is like riding a bicycle. To keep your balance, you must keep moving."
...
{
    var fname: string[] = ["AbduRehman", "Moon", "Anas", "Bilal"];
